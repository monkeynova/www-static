...
const testScenarios = [
    ...
    defineTest(
        ...
        async () => {
            const testBoardDef = [
                ...
                [{ classes: ['plain'], walls: ['west'], pusher: { direction: 'east', steps: [1, 2, 3, 4, 5] } }, { classes: ['plain'], walls: ['west', 'east'] }] // Push east panel at (1,0), Tile (1,1) has a west wall
            ];
            const boardData = new Board(testBoardDef);
    ...
    defineTest(
        ...
        async () => {
            const testBoardDef = [
                [{ classes: ['plain'], walls: ['north', 'west'] }, { classes: ['plain'], walls: ['north'] }, { classes: ['plain'], walls: ['north', 'east'] }],
                [{ classes: ['conveyor-east'], walls: ['west'] }, { classes: ['plain'], walls: ['south'], pusher: { direction: 'north', steps: [1, 2, 3, 4, 5] } }, { classes: ['plain'], walls: ['east'] }], // Conveyor at (1,0), Push north panel at (1,1)
                [{ classes: ['plain'], walls: ['south', 'west'] }, { classes: ['plain'], walls: ['south'] }, { classes: ['plain'], walls: ['south', 'east'] }]
            ];
            const boardData = new Board(testBoardDef);
    ...
    defineTest(
        ...
        async () => {
            const testBoardDef = [
                [{ classes: ['plain'], walls: ['north', 'west'] }, { classes: ['plain'], walls: ['north'] }, { classes: ['plain'], walls: ['north', 'east'] }],
                [{ classes: ['plain'], walls: ['west'] }, { classes: ['plain'], walls: ['south'], pusher: { direction: 'north', steps: [2, 4] } }, { classes: ['plain'], walls: ['east'] }], // Push north panel at (1,1), fires on steps 2 and 4
                [{ classes: ['plain'], walls: ['south', 'west'] }, { classes: ['plain'], walls: ['south'] }, { classes: ['plain'], walls: ['south', 'east'] }]
            ];
            const boardData = new Board(testBoardDef);
            const robot = new Robot(1, 1, 'north'); // Robot starts on push panel
...
`);
    ...
    defineTest(
        ...
        async () => {
            ...
            const testBoardDef = [
                [ { classes: ['conveyor-east'], walls: ['north', 'west'] }, { classes: ['plain'], walls: ['north'] }, { classes: ['plain'], walls: ['north', 'east', 'south'], laser: { direction: 'north' } } ], // Added south wall
                [ { classes: ['plain'], walls: ['south', 'west'] }, { classes: ['plain'], walls: ['south'] }, { classes: ['plain'], walls: ['south', 'east'] } ]
            ];
            const boardData = new Board(testBoardDef);
    ...
    defineTest(
        ...
        async () => {
            ...
            const testBoardDef = [
                [ { classes: ['plain'], walls: ['north', 'south'], laser: { direction: 'east' } } ] // Missing 'west' wall
            ];
    ...
    defineTest(
        ...
        async () => {
            ...
            const testBoardDef = [
                [ { classes: ['plain'], walls: ['north', 'west'] }, { classes: ['conveyor-east'], walls: ['north', 'west', 'east'], laser: { direction: 'east' } }, { classes: ['plain'], walls: ['north', 'east'] } ],
                [ { classes: ['plain'], walls: ['south', 'west'] }, { classes: ['plain'], walls: ['south'] }, { classes: ['plain'], walls: ['south', 'east'] } ]
            ];
            const boardData = new Board(testBoardDef);
    ...
    defineTest(
        ...
        async () => {
            ...
            const testBoardDef = [
                [ { classes: ['plain'], walls: ['north', 'west'] }, { classes: ['gear-cw'], walls: ['north', 'south'], laser: { direction: 'north' } }, { classes: ['plain'], walls: ['north', 'east'] } ],
                [ { classes: ['plain'], walls: ['south', 'west'] }, { classes: ['plain'], walls: ['south'] }, { classes: ['plain'], walls: ['south', 'east'] } ]
            ];
            const boardData = new Board(testBoardDef);
